...
type ValidSizes = 'XS' | 'S' | 'M' | 'L' | 'XL' | 'XXL' | 'unitalla' | 'curvy';
type ValidTypes = 'ropa' | 'lencería' | 'accesorios';
  ...
  products: [
    {
      ...
      inStock: 7,
      price: 75,
      sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL', 'unitalla', 'curvy'],
    ...
    },
    {
      ...
      inStock: 5,
      price: 200,
      sizes: ['XS', 'S', 'M', 'XL', 'XXL', 'unitalla', 'curvy'],
